<?php
	...
	$sql = "UPDATE  formazione_post_base SET Data_rilascio = '".$data_rilascio."',Nome_titolo = '".$nome_titolo."',Luogo_consegna='".$luogo_consegna."',Comune_consegna = '".$comune_consegna."', Provincia_consegna = '".$provincia_consegna."',Tipo_titolo = '".$tipo_titolo."' WHERE Id = ".$id."";
